...
export default function ClothesAttributeFilter({ onAddClick }: ClothesAttributeFilterProps) {
  ...
  return (
    <div className="flex items-center justify-between px-5 py-2.5">
      ...
      <Button
        onClick={onAddClick}
        className="h-[36px] px-[18px] py-2.5 bg-green-500 hover:bg-green-400/90 text-white font-['SUIT:Bold',_sans-serif] text-[18px] tracking-[-0.45px] rounded-[12px] gap-1.5"
      >
        속성 추가
      </Button>
    </div>
