...
// 이 컴포넌트는 오직 프로필 설정 페이지의 날씨 알림 토글을 위해 존재합니다.
    ...
    return (
        ...
        >
            <SwitchPrimitive.Thumb
                ...
                className={cn(
                    'bg-background dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground pointer-events-none block size-3.5 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[17px] data-[state=unchecked]:translate-x-0'
                )}
            />
        </SwitchPrimitive.Root>
    );
